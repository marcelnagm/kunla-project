        ...
        <div class="container-xxlg container-fluid">
            ...
            <div class="row">
                <div class="col-12 header header-nobackground">
                    <nav class="navbar navbar-expand-lg navbar-light ">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-top">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link-black active" aria-current="page" href="#">&lt;Home /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link-black" href="#">&lt;Formação /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link-black" href="#">&lt;Contato/></a>
                                </li>
                    ...
                    <div class="subtitle-search font-black">
                        <b> <span class="ex2">Mapeamento</span> Tech</b>
                    </div>
                ...
                <div class="row section p-b-5">  
                    <div class="col-3 filter-side">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="{{$candidate->city}}">
                                <label class="form-check-label" for="{{$candidate->city}}">{{$candidate->city}}</label>
                            </div>
                            @endforeach
                        </div>
                        <div class="container-fluid">
                    ...
                    <div class="col-8 container-fluid">
                        ...
                        <div class="container-fluid row" id="results">
                            ...
                            <div class="col-4">
                                <a class="btn-sm btn-change">Ver detalhes</a>
                            </div>                                                        
                        </div>
                        <hr>
                        @endforeach
                        <div id="see-more" class="text-center">
                                <a class="btn ex2">Ver Mais</a>
                        </div>
                    </div>
