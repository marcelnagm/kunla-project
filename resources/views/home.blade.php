            ...
            <div class="row">
                ...
                <div class="row section">  
                    ...
                    <div class="col-8 section-texts">  
                        <div class="subtitle-2">
                            Como a <b><span class="ex2">{</span>Kunla pode ajudar<span class="ex2">}</span></b> a minha empresa?
                        </div>
                        <div class="text-base-2">
                            Disponibilizamos mapeamentos de profissionais de tecnologia para facilitar seu processo de recrutamento e seleção. É simples e ágil, basta identificar o profissional que deseja e entrar em contato conosco. 
                        </div>
                    </div>  
                </div>  
                ...
                <div class="row section">  
                    <div class="col-8 section-texts">  
                        <div class="subtitle-4">
                            Como a Kunla  <span class="ex2">[</span><b>ajuda pessoas</b><span class="ex2">]</span>  a ingressarem no mercado de tecnologia?
                        </div>
                        <div class="text-base-2">
                            A Kunla tem um programa de formação gratuito para pessoas de baixa renda, onde <b>ensina e ajuda a desenvolver novos profissionais para o mercado de tecnologia.</b>
                        </div>
                    </div>  
                    <div class="col-4">  
                ...
                <div class="row section">  
                    ...
                    <div class="col section-texts-2">  
                        <div class="subtitle-4">
                            Sobre a <b><span class="ex2">{</span>Kunla<span class="ex2">}</span></b>  
                        </div>
                        <div class="text-base-2">
                            ...
                            <div class="subsection-5">
                                Temos uma universidade coorporativa focada em cursos de tecnologia e totalmente gratuita para o público de baixa renda.
                            </div>
                    ...
                    <div class="col-5 right-part">
                        <div class="subtitle-4" >
                            <b>
                                ...
                                <span class="ex2"><</span><b>tecnologia</b><span class="ex2">> &&</span>  não sabe por onde começar?
                            </b>
                        </div>
                        <div class="text-base-2" >
                            <b> Está disposto a aprender e dedicar o seu tempo para mudar sua vida?</b> 
                        </div>
                    ...
                    <div class="col-4">
                        <div class="footer-icons">
                            ...
                            <div class="footer-text" style="margin-top: 24px;">                           
                                Politica de Privacidade <br>& Termos de Uso
                            </div> 
                        </div>
                    </div>
                </div>
